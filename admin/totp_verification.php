...
<html lang="en">
   <head>
      ...
      <title>rguktn|Students Signup</title>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-8 col-md-offset-2">
               ...
               <br />
               <br />
               <form class="form-light mt-20" action="totp_action.php" enctype="multipart/form-data" method="post" role="form">
                 
                      <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <input type="tetx" class="form-control" placeholder="Enter Otp" name="otp" required>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <button type="submit" class="btn btn-two" value="submit">Enter OTP</button>
                        </div>
                        </div>
               </form>
            </div>
