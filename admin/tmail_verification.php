      ...
      <div class="container">
         <div class="row">
            <div class="col-md-8 col-md-offset-2">
               ...
               <br />
               <br />
               <form class="form-light mt-20" action="tmail_action.php" enctype="multipart/form-data" method="post" role="form">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="Student Name" name="sname" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                           <button type="submit" class="btn btn-two" value="submit">Send OTP</button>
                        </div>
                        </div>
