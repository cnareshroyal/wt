...
<head>
	...
	<title>rguktn|Student|Assignment</title>
				...
				<?php 
							...
							if ($result1->num_rows > 0) {
								while($row = $result1->fetch_assoc()) {
									$sql12 = "SELECT * FROM assignment where branch='".$row['branch']."'";
									...
									if ($result12->num_rows > 0) 
									{
										...
										while($row = $result12->fetch_assoc()) 
										{
											...
											<td><a download target="_blank" href="http://localhost/rguktn/files/<?php echo $row['file'];  ?>"> Download Assignment</a></td>
											</tr>
											<?php
										}
									}
