...
<head>
	...
	<title>rguktn|Teachers Login</title>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">
					<img src="../assets/images/logo.png" alt="Techro HTML5 template" style="max-height: 70px;margin-top:-2%"></a></a>
			</div>
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<form class="form-light mt-20" action="tea_login_action.php" method="post" role="form">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Email id or Username" name="username" required>
							</div>
							<div class="form-group">
							...
							<a href="tmail_verification.php" class="btn btn-two">Signup</a><p><br/></p>
						</form>
					</div>
					<!---	<div class="col-md-4">
						<div class="row">
