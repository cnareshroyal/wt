	...
	<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<br />
						<br />
						<form class="form-light mt-20" action="ssignup_action.php" enctype="multipart/form-data" method="post" role="form">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Phone No" name="pno" maxlength="10" required>
							</div>
							<div class="form-group">
							<?php 
