	...
	<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<br />
						<br />
						<form class="form-light mt-20" action="add_action.php" method="post" role="form">
							
							<div class="form-group">
								<label>Add Branch</label>
								<input type="text" class="form-control" placeholder="add branch" name="add_branch">
							</div>
							<div class="form-group">
							...
							<button type="submit" class="btn btn-two" value="submit">Add</button>
							<a href="show_branch.php" class="btn btn-two">Show</a>
							<a href="login_branch.php" class="btn btn-two">Login</a><p><br/></p>
						</form>
					</div>
					<!---<div class="col-md-4">
						<div class="row">
