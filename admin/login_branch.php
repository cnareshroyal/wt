...
<head>
	...
	<title>rguktn|Branch Login</title>
	...
	<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<br />
						<br />
						<form class="form-light mt-20" action="login_action.php" method="post" role="form">
							...
							<a href="add.php" class="btn btn-two">Back</a><p><br/></p>
						</form>
					</div>
				<!---	<div class="col-md-4">
						<div class="row">
